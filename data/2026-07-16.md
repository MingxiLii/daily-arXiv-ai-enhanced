...
### [4] [jQMC: A JAX-based ab initio quantum Monte Carlo package designed for GPU-accelerated computing](https://arxiv.org/abs/2607.13781)
...
### [5] [Solid-State NMR Dipolar Recoupling in Presence of Large Chemical Shielding Anisotropies by Quaternion-Based Effective Hamiltonian Optimal Control](https://arxiv.org/abs/2607.13907)
...
### [7] [Direct Imaging of Temperature Evolution of Polar Nanoregions and Chemically Ordered Regions in PMN Relaxor: Evidence for Polar Phase Percolation](https://arxiv.org/abs/2607.13364)
...
### [8] [Resistivity in Dilute Cu-3d Alloys Governed by Disorder-Induced Band Broadening](https://arxiv.org/abs/2607.13419)
*Kenji Yamaguchi*
...
### [9] [Hybridization-controlled re-entrant electronic phase switching and moire-confined states in twisted bilayer PtTe2](https://arxiv.org/abs/2607.13529)
...
### [10] [Rotation topological states: theory and material realization](https://arxiv.org/abs/2607.13575)
...
### [11] [Role of small-radius and high-electronegativity A-Site dopants in enhancing proton transport and stability of perovskite electrolytes](https://arxiv.org/abs/2607.13657)
...
### [14] [Chemical short-range order controls deformation pathways in a complex concentrated alloy](https://arxiv.org/abs/2607.13896)
...
### [15] [The WEST code for large-scale excited-state materials simulations](https://arxiv.org/abs/2607.14025)
...
### [16] [Orbital Hybridization Induces Giant Cubic Rashba Effect at Cu/WO$_{3}$ Interface](https://arxiv.org/abs/2607.14069)
...
### [19] [Networked Intelligence: Active Shared Context Graphs for Human-AI Team Science](https://arxiv.org/abs/2607.13220)
...
### [25] [SAFETY SENTRY: Context-Aware Human Intervention via EXECUTE-ASK-REFUSE Routing](https://arxiv.org/abs/2607.13594)
...
### [26] [Automatic Ordinary Differential Equations Discovery For Biological Systems Using Large Language Model Powered Agentic System](https://arxiv.org/abs/2607.13608)
...
### [27] [STOCKTAKE: Measuring the Gap Between Perception and Action in LLM Agents with a Fair Oracle](https://arxiv.org/abs/2607.13618)
...
### [28] [AgentCompass: A Unified Evaluation Infrastructure for Agent Capabilities](https://arxiv.org/abs/2607.13705)
...
### [30] [AI-accelerated End-to-End Framework for Rapid Professional Upskilling](https://arxiv.org/abs/2607.14044)
...
### [31] [Deep Interaction: An Efficient Human-AI Interaction Method for Large Reasoning Models](https://arxiv.org/abs/2607.14049)
...
### [32] [Accelerating gas-network feasibility screening with a physics-informed graph neural network surrogate](https://arxiv.org/abs/2607.13610)
...
### [33] [From Forecasts to Auditable Reports: Evidence Contracts for LLM-Assisted Housing-Guarantee Risk Monitoring](https://arxiv.org/abs/2607.14026)
...
### [34] [Uncertainty-Aware Sequential Decision Rules for Event-Triggered LLM Invocation in Streaming Systems](https://arxiv.org/abs/2607.13048)
*Zhaohui Wang*
...
### [35] [Reassessing Muon for Matrix Factorization](https://arxiv.org/abs/2607.13246)
...
### [37] [ExTernD: Expanded-Rank Ternary Decomposition Ternary LLM PTQ with Accuracy Approaching Any Quantization Level](https://arxiv.org/abs/2607.13511)
*Chethan Reddy G. P*
...
### [38] [Maximally Robust Satisficing Bayesian Optimization](https://arxiv.org/abs/2607.13652)
...
### [39] [MxGPS: Multiplex Graph Transformers for a Power Grid Foundation Model](https://arxiv.org/abs/2607.13763)
...
### [40] [Lighthouse RL: Sample-Efficient Circuit Optimization via Strategic Reset Points](https://arxiv.org/abs/2607.14008)
...
### [41] [MetaPerch: Learning from metadata for bioacoustics foundation models](https://arxiv.org/abs/2607.14072)
